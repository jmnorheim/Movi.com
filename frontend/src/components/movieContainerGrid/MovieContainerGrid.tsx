 ...
 * includes an `AddToLibraryButton` for adding the movie to one of the user's libraries or favorites.
 *
 * Props:
 ...
 * - Incorporates an `AddToLibraryButton` for each movie to enable adding the movie to libraries or favorites, visible only to logged-in users.
