...
export type GetMoviesQuery = { __typename?: 'Query', movies: Array<{ __typename?: 'Movie', averageRating: number, genres: Array<string>, imdbID: string, isAdult: boolean, originalTitle: string, poster?: string | null, primaryTitle: string, runtimeMinutes: number, startYear: number, totalVotes: number }> };
