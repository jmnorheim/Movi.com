...
export type AddMovieToFavoriteMutation = {
  __typename?: "Mutation";
  addMovieToFavorite: { __typename?: "User"; userID: string };
};
...
export type AddMovieToLibraryMutation = {
  __typename?: "Mutation";
  addMovieToLibrary: { __typename?: "Library"; userID: string };
};
...
export type DeleteUserMutation = {
  __typename?: "Mutation";
  deleteUser: { __typename?: "User"; userID: string };
};
...
export type GetLibraryQuery = {
  __typename?: "Query";
  libraryByID: { __typename?: "Library"; movies: Array<string>; name: string };
};

export type LibraryByUserAndNameQueryVariables = Exact<{
  userId: Scalars["ID"]["input"];
  name: Scalars["String"]["input"];
}>;

export type LibraryByUserAndNameQuery = {
  __typename?: "Query";
  libraryByUserAndName: {
    __typename?: "Library";
    libraryID: string;
    movies: Array<string>;
    name: string;
...
export type GetMovieStatsQuery = {
  __typename?: "Query";
  movieStats: {
    __typename?: "MovieStats";
    averageRatingRange: { __typename?: "Range"; max: number; min: number };
    releaseYearRange: { __typename?: "Range"; max: number; min: number };
    runtimeMinutesRange: { __typename?: "Range"; max: number; min: number };
    totalVotesRange: { __typename?: "Range"; max: number; min: number };
  };
};
...
export type MoviesByLibraryIdQuery = {
  __typename?: "Query";
  moviesByLibraryID?: Array<{
    __typename?: "Movie";
    imdbID: string;
    primaryTitle: string;
    averageRating: number;
...
export type GetUsersLibrariesQuery = {
  __typename?: "Query";
  librariesByUserID: Array<{
    __typename?: "Library";
    movies: Array<string>;
    name: string;
    libraryID: string;
...
export type IsMovieInFavoriteQuery = {
  __typename?: "Query";
  movieInFavoriteByUserID: boolean;
};
...
export type AddLibraryToUserMutation = {
  __typename?: "Mutation";
  addLibrary: { __typename?: "User"; userID: string };
};
...
export type RemoveLibraryMutation = {
  __typename?: "Mutation";
  removeLibrary: { __typename?: "User"; userID: string };
};
...
export type MutationMutation = {
  __typename?: "Mutation";
  removeMovieFromFavorite: { __typename?: "User"; userID: string };
};
...
export type RemoveMovieFromLibraryMutation = {
  __typename?: "Mutation";
  removeMovieFromLibrary: { __typename?: "Library"; libraryID: string };
};
...
export type VerifyPasswordQuery = {
  __typename?: "Query";
...
export const AddMovieToFavoriteDocument = {
  ...
  definitions: [
    {
      ...
      operation: "mutation",
      name: { kind: "Name", value: "AddMovieToFavorite" },
      variableDefinitions: [
        {
  ...
  AddMovieToFavoriteMutation,
  AddMovieToFavoriteMutationVariables
>;
export const AddMovieToLibraryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddMovieToLibrary" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  AddMovieToLibraryMutation,
  AddMovieToLibraryMutationVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "movies" } },
                { kind: "Field", name: { kind: "Name", value: "name" } },
              ],
            },
          },
...
export const LibraryByUserAndNameDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "LibraryByUserAndName" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  LibraryByUserAndNameQuery,
  LibraryByUserAndNameQueryVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "primaryTitle" },
                },
                {
                  kind: "Field",
...
export const GetMovieStatsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMovieStats" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "movieStats" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "averageRatingRange" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "releaseYearRange" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "max" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "runtimeMinutesRange" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "max" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "totalVotesRange" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "max" } },
...
} as unknown as DocumentNode<GetMovieStatsQuery, GetMovieStatsQueryVariables>;
export const MoviesByLibraryIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "MoviesByLibraryID" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  MoviesByLibraryIdQuery,
  MoviesByLibraryIdQueryVariables
>;
export const GetRecommendedDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetRecommended" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "MovieInput" },
            },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getRecommendedMovies" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "movie" },
...
} as unknown as DocumentNode<GetRecommendedQuery, GetRecommendedQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getFavorites" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<GetFavoritesQuery, GetFavoritesQueryVariables>;
export const GetUsersLibrariesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUsersLibraries" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "librariesByUserID" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userID" },
  ...
  GetUsersLibrariesQuery,
  GetUsersLibrariesQueryVariables
>;
export const IsMovieInFavoriteDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "IsMovieInFavorite" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "movieInFavoriteByUserID" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userID" },
  ...
  IsMovieInFavoriteQuery,
  IsMovieInFavoriteQueryVariables
>;
export const AddLibraryToUserDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "addLibraryToUser" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "libraryName" },
          },
          type: {
            kind: "NonNullType",
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "addLibrary" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userID" },
  ...
  AddLibraryToUserMutation,
  AddLibraryToUserMutationVariables
>;
export const RemoveLibraryDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RemoveLibrary" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  RemoveLibraryMutation,
  RemoveLibraryMutationVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "removeMovieFromFavorite" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userID" },
...
export const RemoveMovieFromLibraryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  RemoveMovieFromLibraryMutation,
  RemoveMovieFromLibraryMutationVariables
>;
export const VerifyPasswordDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "VerifyPassword" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<VerifyPasswordQuery, VerifyPasswordQueryVariables>;
